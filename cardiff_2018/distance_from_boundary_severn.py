...
bc2 = [DirichletBC(V, 0.0, 10), DirichletBC(V, 0.0, 11),          # Double check that
...
# 3 is the inlet of the basin - I'm letting the distance function there start at 1e5
# Set up hydraulic structures
bc2 = [DirichletBC(V, 0.0, 100), DirichletBC(V, 0.0, 200),          # Double check that
       DirichletBC(V, 0.0, 300), DirichletBC(V, 0.0, 400), DirichletBC(V, 1e8, 10)]
v2 = TestFunction(V)
u2 = Function(V)
